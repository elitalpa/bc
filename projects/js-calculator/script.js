...
The multiplication of ${firstNumber} and ${secondNumber} is equal to ${firstNumber * secondNumber}
The division of ${firstNumber} and ${secondNumber} is equal to ${firstNumber / secondNumber}`);
